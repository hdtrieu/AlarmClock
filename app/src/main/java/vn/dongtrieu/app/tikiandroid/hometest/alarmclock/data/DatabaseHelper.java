package vn.dongtrieu.app.tikiandroid.hometest.alarmclock.data;
...
import vn.dongtrieu.app.tikiandroid.hometest.alarmclock.AlarmUtilsKt;
...
public final class DatabaseHelper extends SQLiteOpenHelper {
    ...
    long addAlarm(Alarm alarm) {
        return getWritableDatabase().insert(TABLE_NAME, null, AlarmUtilsKt.toContentValues(alarm));
    }
    ...
    public int updateAlarm(Alarm alarm) {
        ...
        return getWritableDatabase()
                .update(TABLE_NAME, AlarmUtilsKt.toContentValues(alarm), where, whereArgs);
    }
    ...
    public ArrayList<Alarm> getAlarms() {
        ...
        try{
            ...
            return AlarmUtilsKt.buildAlarmList(c);
        } finally {
